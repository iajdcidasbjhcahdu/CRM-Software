...
import EmployeeProjectDetailContent from "./EmployeeProjectDetailContent";
  ...
  if (!result.success) {
    return (
      <div className="flex items-center justify-center h-64">
        <p className="text-slate-500 dark:text-slate-400">Project not found or you do not have access.</p>
      </div>
    );
  }

  return (
    <EmployeeProjectDetailContent
