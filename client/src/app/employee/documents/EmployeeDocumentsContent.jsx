...
export default function EmployeeDocumentsContent({ initialData }) {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Documents from your assigned projects.</p>
      </div>
