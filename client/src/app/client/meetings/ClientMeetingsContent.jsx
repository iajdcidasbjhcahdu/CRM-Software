...
export default function ClientMeetingsContent({ initialData }) {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">View all meetings scheduled for your projects.</p>
      </div>
            ...
            return (
              <div
                ...
                className={`bg-white dark:bg-slate-950 rounded-2xl border p-5 transition-colors ${
                  upcoming
                    ? "border-[#5542F6]/20 dark:border-[#5542F6]/30"
