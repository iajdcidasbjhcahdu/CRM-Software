...
export default function ClientDocumentsContent({ initialData }) {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">View all documents related to your projects.</p>
      </div>
              ...
              <div className="flex items-center gap-3 flex-shrink-0">
                ...
                {doc.fileUrl && (
                  <a
                    ...
                    className="px-3 py-1.5 text-xs font-medium text-[#5542F6] hover:bg-[#5542F6]/10 rounded-lg transition-colors flex items-center gap-1.5"
                  >
