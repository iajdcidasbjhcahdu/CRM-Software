    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: "Projects", href: "/sales/projects" },
          { label: project.name },
        ]}
        actions={
          <Link
            href={`/sales/projects/${project.id}/edit`}
        ...
        <div className="bg-white dark:bg-slate-950 rounded-[24px] p-6 lg:p-8 border border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-none shadow-slate-200/50 dark:shadow-none">
          ...
          <div className="flex flex-col">
            <InfoRow
              ...
              link={`/sales/clients/${project.client.id}`}
            />
            <InfoRow
              icon={User}
              label="Contact"
            ...
            {project.deal && (
              <>
                <InfoRow
                  ...
                  link={`/sales/deals/${project.deal.id}`}
                />
                <InfoRow
                  icon={DollarSign}
                  label="Deal Value"
                ...
                <div key={ps.id} className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <Link href={`/sales/services/${ps.service?.id}`} className="text-sm font-semibold text-slate-900 dark:text-slate-50 hover:text-indigo-600 transition-colors">
                        {ps.service?.name}
                      </Link>
